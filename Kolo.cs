...
namespace Lr_7
{
    ...
    {
        // Константи
        const int DefaultRadius = 10; // Радіус кола за замовчуванням, пікс
                                      // Поля
        ...
        { // Радіус кола
            ...
            set
            {
                ...
                _radius = value >= 100*100 ? 100*100 : value;
                _radius = value <= 10*10 ? 10*10 : value;
            }
        }
        ...
        public Kolo(Graphics graphics, int X, int Y)
{
...
public Kolo(Graphics graphics, int X, int Y, int Radius)
{
this.graphics = graphics;
this.X = X;
this.Y = Y;
